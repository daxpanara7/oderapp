...
<head>
    ...
    <style>
        /* Apply a background color or image to the entire page */
        body {
            background: #f0f4f8;
        ...
        /* Center the content and add some padding and a shadow */
        .thank-you-container {
            background: #fff;
            padding: 40px 60px;
            border-radius: 8px;
...
viewBox="0 0 512 434.91"
 ...
 <g id="Layer_x0020_1">
  ...
  <path fill="white" d="M372.38 86.95l19.89 18.79 43.22 -43.86c3.9,-3.95 6.34,-7.13 11.14,-2.18l15.59 15.97c5.12,5.06 4.86,8.03 0.03,12.74l-61.08 60.03c-10.18,9.98 -8.41,10.59 -18.73,0.35l-36.3 -36.1c-2.15,-2.32 -1.92,-4.68 0.44,-7l18.09 -18.77c2.74,-2.88 4.92,-2.63 7.71,0.03z"/>
        ...
        <a href="{{ $redirectUrl }}" class="new-order-btn">Do you want to create a new order?</a>
    </div>
</body>
</html>
